var fs = require("fs"),
    ...
    browserScripts = require('./browser-scripts'),
    safeExecuteJsScript = browserScripts.safeExecuteJsScript,
    safeExecuteAsyncJsScript = browserScripts.safeExecuteAsyncJsScript,
    _waitForConditionInBrowserJsScript = browserScripts.waitForConditionInBrowserJsScript;
