...
/**
 * sendTouchCommands(element, touchGestures) -> cb(err, touchStateObjects)
 *
 * @jsonWire POST /session/:sessionId/touch/perform
 */
commands.sendTouchCommands = function (element, touchGestures, cb) {
  this._jsonWireCall({
    method: 'POST',
...
/**
 * sendMultiActionCommands(element, actions) -> cb(err, touchStateObjects)
 *
 * @jsonWire POST /session/:sessionId/touch/multi/perform
 */
commands.sendMultiActionCommands = function (element, actions, cb) {
  this._jsonWireCall({
    method: 'POST',
    relPath: '/touch/multi/perform',
    data: {
      elementId: element.value.toString(),
      actions: actions
    },
    cb: callbackWithData(cb, this)
  });
