...
exports.buildTransferPromiseness = function(PromiseChainWebdriver) {
  ...
  return function(target, promise) {
    _(Q_CORE_METHODS).union(PromiseChainWebdriver.promisedChainMethods)
