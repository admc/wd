...
TouchAction.prototype.press = function (opts) {
  opts = opts || {};
  ensureXY(opts);
  this.pushTouchGesture('press', opts, false);
  return this;
};
...
TouchAction.prototype.moveTo = function (opts) {
  opts = opts || {};
  this.pushTouchGesture('moveTo', opts, false);
  return this;
};
...
TouchAction.prototype.longPress = function (opts) {
  opts = opts || {};
  ensureXY(opts);
  this.pushTouchGesture('longPress', opts, false);
  return this;
};
...
TouchAction.prototype.wait = function (opts) {
  ...
  this.pushTouchGesture('wait', opts, false);
  return this;
};
