...
W3CActions.prototype.addInputDevice = function (inputSource) {
  if (_.isNil(inputSource.id)) {
    if (inputSource.type === "pointer") {
      ...
      if (pointerType === "touch") {
        inputSource.id = "finger" + this.touchCount;
        this.touchCount++;
      } else {
  ...
  this.inputs = this.inputs.concat(inputSource);
  return this;
};
...
W3CActions.prototype.perform = function(cb) {
  /*if(typeof cb === 'function') {
    this.driver.performW3CActions(this, cb);
  } else {
    this.driver.performW3CActions(this);
  }*/
};

W3CActions.prototype.toJSON = function () {
  return {
    actions: _.map(this.inputs, function (input) { return input.toJSON(input); })
  };
};
