...
wd.prototype.init = function(desired, cb) {
  var _this = this;
...
wd.prototype.execute = function(code, cb) {
  var _this = this;
...
wd.prototype.get = function(url, cb) {
  var _this = this;  
...
exports.remoteWebDriver = function(host, port, username, accessKey) {
