...
exports.promiseRemote = function() {
  var args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
  var rwc = parseRemoteWdConfig(args);
  return new (promiseWebdriver(factory.WebDriver, false))(rwc);
};

// chai-as-promised promisify method
// building it dynamically so that monkey pathc works
exports.buildTransferPromiseness = function() {
  return utils.buildTransferPromiseness(promiseWebdriver(factory.WebDriver, true));
}.bind();

// creates a webdriver object using the Q promise wrap chained
exports.promiseChainRemote = function() {
  var args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
  var rwc = parseRemoteWdConfig(args);
  return new (promiseWebdriver(factory.WebDriver, true))(rwc);
};

exports.SPECIAL_KEYS = SPECIAL_KEYS;

// exposing useful stuff
exports.Q = Q;
exports.findCallback = utils.findCallback;
exports.varargs = utils.varargs;

// exposing webdriver object to allow easy monkey patching
// use with care
exports.webdriver = factory.WebDriver;
