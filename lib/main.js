...
var webdriver = function(remoteWdConfig) {
  ...
  this._getInitOpts = function() {
    ...
    if ((this.username != null) && (this.accessKey != null)) {
      var authString = this.rwc.username + ":" + this.rwc.accessKey;
...
parseRemoteWdConfig = function(args) {
  var accessKey, host, port, username, _ref;
  if (typeof (args != null ? args[0] : void 0) === 'object') {
    _ref = args[0], host = _ref.host, port = _ref.port, username = _ref.username, accessKey = _ref.accessKey;
  } else {
