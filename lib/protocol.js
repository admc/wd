...
protocol.elementByLinkText = function(value, cb) {
  protocol.element.apply(this, ['link text', value, cb]);
};

protocol.elementById = function(value, cb) {
  protocol.element.apply(this, ['id', value, cb]);
};

protocol.elementByName = function(value, cb) {
  protocol.element.apply(this, ['name', value, cb]);
};

protocol.elementByCss = function(value, cb) {
  protocol.element.apply(this, ['css selector', value, cb]);
};
...
protocol.elementsByLinkText = function(value, cb) {
  protocol.elements.apply(this, ['link text', value, cb]);
};

protocol.elementsById = function(value, cb) {
  protocol.elements.apply(this, ['id', value, cb]);
};

protocol.elementsByName = function(value, cb) {
  protocol.elements.apply(this, ['name', value, cb]);
};

protocol.elementsByCss = function(value, cb) {
  protocol.elements.apply(this, ['css selector', value, cb]);
};
