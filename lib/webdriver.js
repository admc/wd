 ...
 * path maybe a full file path, a directory path (finishing with /), the screenshot 
 * name, or left blank (will create a file in the system temp dir).
 */
