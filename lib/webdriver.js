 ...
 */
webdriver.prototype.logTypes = function(cb) {
  this._jsonWireCall({
    method: 'GET'
    , relPath: '/log/types'
    , cb: this._callbackWithData(cb)
 ...
 */
webdriver.prototype.log = function(logType, cb) {
  this._jsonWireCall({
    method: 'POST'
    , relPath: '/log'
    , cb: this._callbackWithData(cb)
...
webdriver.prototype._buildBySuffixMethods = function(type, prototype, singular, plural) {
  if(singular){
    ...
    prototype['waitForElement' + utils.elFuncSuffix(type)] = function() {
      var args = __slice.call(arguments, 0);
      args.unshift(utils.elFuncFullType(type));
      this.waitForElement.apply(this, args);
    };
...
_.each(utils.elementFuncTypes, function(suffix) {
  webdriver.prototype._buildBySuffixMethods(suffix, webdriver.prototype);
});
 ...
 */
webdriver.prototype.getLocationInView = function(element, cb) {
  this._jsonWireCall({
    method: 'GET'
