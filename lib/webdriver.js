...
// _element: alternate element class (to be use by the promise wrapper)
var webdriver = module.exports = function(configUrl, _element) {
  EventEmitter.call( this );
  this.sessionID = null;
  this.configUrl = configUrl;
  element = _element || require('./element').element;
...
webdriver.prototype.haltChain = function(){
...
var findCallback = function(_arguments){
  var fargs = utils.varargs(_arguments);
 ...
 */
webdriver.prototype.waitForElement = function(using, value, timeout){
  var cb = findCallback(arguments);
  var _this = this;
 ...
 */
webdriver.prototype.waitForVisible = function(using, value, timeout) {
  var cb = findCallback(arguments);
  var _this = this;
  var endTime = Date.now() + timeout;
...
_.each(utils.elementFuncTypes, function(type) {
   ...
   * @jsonWire POST /session/:sessionId/element
   */
  webdriver.prototype['element' + utils.elFuncSuffix(type)] = function(value) {
    var cb = findCallback(arguments);
   ...
   * @docOrder 4
   */
  webdriver.prototype['element' + utils.elFuncSuffix(type)+ 'OrNull'] = function(value) {
    var cb = findCallback(arguments);
   ...
   * @docOrder 6
   */
  webdriver.prototype['element' + utils.elFuncSuffix(type)+ 'IfExists'] = function(value) {
    var cb = findCallback(arguments);
    webdriver.prototype.elements.apply(this, [utils.elFuncFullType(type), value,
      function(err, elements) {
        if(!err) {
   ...
   * @docOrder 8
   */
  webdriver.prototype['hasElement' + utils.elFuncSuffix(type)] = function(value) {
    var cb = findCallback(arguments);
   ...
   */
  webdriver.prototype['waitForElement' + utils.elFuncSuffix(type)] = function(value, timeout) {
    var cb = findCallback(arguments);
   ...
   */
  webdriver.prototype['waitForVisible' + utils.elFuncSuffix(type)] = function(value, timeout) {
    var cb = findCallback(arguments);
   ...
   * @docOrder 2
   */
  webdriver.prototype['elements' + utils.elFuncSuffix(type)] = function(value) {
    var cb = findCallback(arguments);
 ...
 * @docOrder 1
 */
webdriver.prototype.text = function(element) {
  var cb = findCallback(arguments);
  var _this = this;
