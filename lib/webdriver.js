...
webdriver.prototype.queueAdd = function(func){
  if (arguments.length === 2) {
    /* The only way to make queueAdd's function asynchronous is to have another
     * function as the last argument which runs synchronously. This is due to
     * how chain() wraps webdriver methods */
    var cb = arguments[1];
    func(cb);
  } else {
    func();
