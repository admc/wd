...
/**
  ...
  * @jsonWire POST /session/:sessionId/window/:handle/maximize
 */

webdriver.prototype.maximize = function(win, cb) {
this._jsonWireCall({
	method: 'POST'
	, relPath: '/window/'+ encodeURIComponent(win) + '/maximize'
	, cb: this._simpleCallback(cb)
	});
};
...
webdriver.prototype.getTagName = function(element, cb) {
  this._jsonWireCall({
    method: 'GET'
    , relPath: '/element/' + encodeURIComponent(element) + '/name'
    , cb: this._callbackWithData(cb)
  });
};
...
webdriver.prototype.getAttribute = function(element, attrName, cb) {
  this._jsonWireCall({
    method: 'GET'
    , relPath: '/element/' + encodeURIComponent(element) + '/attribute/' + encodeURIComponent(attrName)
    , cb: this._callbackWithData(cb)
  });
};
...
webdriver.prototype.isDisplayed = function(element, cb) {
  this._jsonWireCall({
    method: 'GET'
    , relPath: '/element/' + encodeURIComponent(element) + '/displayed'
    , cb: this._callbackWithData(cb)
  });
};
...
webdriver.prototype.isSelected = function(element, cb) {
  this._jsonWireCall({
    method: 'GET'
    , relPath: '/element/' + encodeURIComponent(element) + '/selected'
    , cb: this._callbackWithData(cb)
  });
};
...
webdriver.prototype.clickElement = function(element, cb) {
  this._jsonWireCall({
    method: 'POST'
    , relPath: '/element/' + encodeURIComponent(element) + '/click'
    , cb: this._simpleCallback(cb)
  });
};
...
webdriver.prototype.getComputedCss = function(element, cssProperty, cb) {
  this._jsonWireCall({
    method: 'GET'
    , relPath: '/element/' + encodeURIComponent(element) + '/css/' + encodeURIComponent(cssProperty)
    , cb: this._callbackWithData(cb)
  });
};
...
webdriver.prototype.type = function(element, keys, cb) {
  ...
  this._jsonWireCall({
    method: 'POST'
    , relPath: '/element/' + encodeURIComponent(element) + '/value'
    , data: {value: keys}
    , cb: this._simpleCallback(cb)
  });
};
...
webdriver.prototype.submit = function(element, cb) {
  this._jsonWireCall({
    method: 'POST'
    , relPath: '/element/' + encodeURIComponent(element) + '/submit'
    , cb: this._simpleCallback(cb)
  });
};
...
webdriver.prototype.clear = function(element, cb) {
  this._jsonWireCall({
    method: 'POST'
    , relPath: '/element/' + encodeURIComponent(element) + '/clear'
    , cb: this._simpleCallback(cb)
  });
};
...
webdriver.prototype._rawText = function(element, cb) {
  this._jsonWireCall({
    method: 'GET'
    , relPath: '/element/' + encodeURIComponent(element) + '/text'
    , cb: this._callbackWithData(cb)
  });
};
...
webdriver.prototype.getLocation = function(element, cb) {
  this._jsonWireCall({
    method: 'GET'
    , relPath: '/element/' + encodeURIComponent(element) + '/location'
    , cb: this._callbackWithData(cb)
  });
};
...
webdriver.prototype.getSize = function(element, cb) {
  this._jsonWireCall({
    method: 'GET'
    , relPath: '/element/' + encodeURIComponent(element) + '/size'
    , cb: this._callbackWithData(cb)
  });
};
