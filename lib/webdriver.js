 ...
 * refresh(cb) -> cb(err)
 *
 * @jsonWire POST POST /session/:sessionId/refresh
 */
...
/**
 * setAsyncScriptTimeout(ms, cb) -> setImplicitWaitTimeout(ms, cb) -> cb(err)
 *
 ...
 *
 * @jsonWire /session/:sessionId/elements
 */
 ...
 *
 * @jsonWire POST /session/:sessionId/element/:id/displayed
 */
