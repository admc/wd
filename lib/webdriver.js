 ...
 */
webdriver.prototype.getWindowSize = function(win, cb) {
this._jsonWireCall({
	method: 'GET'
	, relPath: '/window/'+ win + '/size'
	, cb: this._callbackWithData(cb)
...
/**
  * setWindowSize(handle, width, height, cb) -> cb(err)
  *
  * @jsonWire POST /session/:sessionId/window/:windowHandle/size
 */
webdriver.prototype.setWindowSize = function(win, width, height, cb) {
this._jsonWireCall({
	method: 'POST'
	, relPath: '/window/'+ win + '/size'
    , cb: this._simpleCallback(cb)
