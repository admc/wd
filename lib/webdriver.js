...
var Webdriver = module.exports = function(configUrl) {
  ...
  this.baseUrl = url.parse(url.format(this.configUrl));
  delete this.baseUrl.auth;
...
Webdriver.prototype._buildJsonCallUrl = function(sessionID, relPath, absPath){
  ...
  return utils.resolveUrl( this.baseUrl, path);
};
...
/**
 * Removed `saveScreenshot`; relies on `tmp` module that was breaking mocha by messing with uncaughtException
 *
