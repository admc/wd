module.exports = function(WebDriver) {
  ...
  function enrich(obj, browser){
    ...
    if(obj instanceof Q.makePromise && !obj.__wd_promise_enriched) {
      ...
      // adding withEl and withElement  methods, to be use to go to the scope of the specified element
      // thenResolve is too many characters
      promise.withEl = promise.withElement = promise.thenResolve;

      //console.log("akak", promise.with);
