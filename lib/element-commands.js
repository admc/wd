...
var _ = require("./lodash")
  ...
  , TouchAction = require('./touch-commands')();
...
elementCommands.performTouchAction = function (action, cb) {
  return commands.sendTouchCommands.apply(this.browser, [this, action.gestures, cb]);
};

elementCommands.performMultiAction = function (multiAction, cb) {
  return commands.sendMultiActionCommands.apply(this.browser, [this, multiAction.actions, cb]);
}
