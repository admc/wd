 ...
 * alias for element.performTouch.
 *
 * @jsonWire POST /session/:sessionId/touch/perform
 */
...
/**
 * element.setValueInApp(value, cb) -> cb(err)
 *
 * @jsonWire POST /appium/element/:elementId?/value
 */
elementCommands.setValueInApp = function(value, cb) {
    commands.setValueInApp.apply(this.browser, [this, value, cb]);
};
/**
 * element.setValue(value, cb) -> cb(err)
 * alias for element.setValueInApp, mjsonWire only
 *
 * @jsonWire POST /appium/element/:elementId?/value
 */
elementCommands.setValue = elementCommands.setValueInApp;
